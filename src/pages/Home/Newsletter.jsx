            ...
            <div className="w-full px-1 flex-0 md:w-auto lg:w-1/2">
                <form>
                    ...
                    <div className="flex flex-col sm:flex-row">
                        ...
                        <button type="" className="w-full px-6 py-4 mt-5 text-white text-lg bg-gray-900 rounded-md sm:mt-0 sm:w-auto whitespace-nowrap dark:bg-gray-900"> Subscribe </button>
                    </div>
                </form>
            </div>
        </div>
